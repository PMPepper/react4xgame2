...
import { ModifyCapabilities } from 'types/game/shared/definitions';
import { FacetFaction } from 'types/game/shared/facets';

export default function getTechnologyModifiers(factionTechnologies: FacetFaction<true>['technology']): ModifyCapabilities {
